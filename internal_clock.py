...
class TimePoint:
    ...
    def now(cls, clock_type: ClockType = ClockType.SYSTEM) -> 'TimePoint':
        ...
        # Generate a sequence ID based on high-resolution time
        # This ensures monotonically increasing values even with rapid calls
        sequence_id = int((now_ts * 1000000) % (2**32))
